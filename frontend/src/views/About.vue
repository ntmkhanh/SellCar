        ...
        <div class="row">
            <div class="about-content">
                ...
                <div class="about-content-text">
                    <p>KN is a website specializing in providing high-end cars from Mercedes brands.
...
.about-section .about-content img {
    /* backg6round-color: rgb(249, 249, 249); */
    width: 50%;
    margin-left: 5%;
}
